...
                        <Canvas camera={{ position: [0, 2, 25], fov: 45 }}>
                            ...
                            <GyroCameraControl 
                                isEnabled={gyroPermissionGranted && viewMode === '3d' && !activeSection}
                            />
...
                            <Suspense fallback={null}>
                                {/* PASS REDUCED MOTION PROP */}
                                <GenerativeCore ref={coreRef} onClick={() => setActiveSection('contact')} isPaused={isScenePaused} isMotionReduced={isMotionReduced} />
                                <Satellite occluderRef={coreRef} position={[0, 3, 6]} color="mediumpurple" text="About" onClick={() => setActiveSection('about')} isActive={activeSection === 'about'} isPaused={isScenePaused} isMotionReduced={isMotionReduced} orbitRadius={7} orbitOffset={Math.PI / 2} />
                                <Satellite occluderRef={coreRef} position={[8, -2, 0]} color="orange" text="Projects" onClick={() => setActiveSection('projects')} isActive={activeSection === 'projects'} isPaused={isScenePaused} isMotionReduced={isMotionReduced} orbitRadius={8} orbitOffset={0} />
                                <Satellite occluderRef={coreRef} position={[-8, -2, 0]} color="dodgerblue" text="Skills" onClick={() => setActiveSection('skills')} isActive={activeSection === 'skills'} isPaused={isScenePaused} isMotionReduced={isMotionReduced} orbitRadius={8} orbitOffset={Math.PI} />
                            </Suspense>
